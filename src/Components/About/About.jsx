        ...
        <div className="container">
          <div className="personal__head text-center">
            ...
            <p className="descrp" data-aos="fade-up" data-aos-duration="1500">
              I'm Prashant, a React.js and React Native developer . I love
              taking on new challenges and creating cool digital stuff. From
              making awesome websites to apps that work smoothly on phones, I'm
              all about pushing limits and making great things happen. Let's
